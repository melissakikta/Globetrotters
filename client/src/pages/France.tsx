    ...
    <section className="country">
      ...
      {/* Add an image of country */}
        ...
        <div className="country-text">
          ...
          <p>
            France is full of love, fashion, and art! Check out these amazing places to visit and fun activities to try!
          </p>
          <p>
          <a href="https://travelfrancebucketlist.com/things-to-do-in-france/" target="_blank" rel="noopener noreferrer">
      ...
      {/* Add an image of country */}
        ...
        <div className="country-text">
          ...
          {/* Info and link to activities article */}
          <p>
            What is more French than food! Don't miss these treats!
          </p>
          <p>
          <a href="https://www.atlasobscura.com/cool-places-to-eat/france" target="_blank" rel="noopener noreferrer">
